      ...
      <div class="modal-content">
        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body text-center">
            ...
            <h4 class="mb-2"><?php echo"".$_SESSION["admin_firstname"]." ".$_SESSION["admin_lastname"].""; ?></h4>
            <p class="text-muted mb-4">
                <?php echo"".$_SESSION["admin_department"].""; ?></p>
            <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              <div class="col-sm-4">
              ...
              <div class="col-sm-8">
                <p class="text-muted mb-0"><?php echo"".$_SESSION["admin_id"].""; ?></p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0"><?php echo"".$_SESSION["admin_username"].""; ?></p>
              </div>
            </div>
          </div>
        </div>
